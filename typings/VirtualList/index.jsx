...
export default defineComponent({
    ...
    setup(props, { emit, slots }) {
        ...
        const updateZone = (offset, forceUpdate = false) => {
        ...
        return () => {
            return (<div class="vir-list" ref={root} onScroll={onScroll} style={{ maxHeight: maxHeight.value + 'px', overflowY: 'auto' }}>
          <div class="main-box" style={{ paddingTop: base.paddingTop + 'px', paddingBottom: base.paddingBottom + 'px' }}>
            {boxContent()}
          </div>
        </div>);
        };
